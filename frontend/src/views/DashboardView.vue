    ...
    <aside class="sidebar">
      <div class="sidebar-inner">
        ...
        <div class="sidebar-section">
          ...
          <p class="sidebar-value">{{ lastCollectedDate }}</p>
        </div>

        <button class="fetch-btn" :disabled="true" @click="fetchData">
          <!--<button class="fetch-btn" :disabled="isLoading" @click="fetchData">-->
        ...
        <Transition name="fade">
          <div v-if="activeTab === 'news'" class="keyword-group">
            <button
              ...
              :key="kw.value"
              class="keyword-btn"
              :class="{ active: selectedKeyword === kw.value }"
              @click="selectKeyword(kw.value)"
            >
              {{ kw.label }}
            </button>
          </div>
